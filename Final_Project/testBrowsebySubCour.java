...
public class testBrowsebySubCour{
    @Test
    public void testViewRoster() {
        ...
        String testName = "Object Oriented Programming";

        // test browse by subject
        assertEquals(testListing.browseBySubName(testSubject, testName).contains(testOffering), true);
    }
}
