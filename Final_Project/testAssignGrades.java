...
// test assign grade function in Instructor class
public class testAssignGrades{
    @Test
    public void testAssignGrades() {
        ...
        // test assign grade function
        String testGrade = "A";
        testInstructor.assignGrade(testStudent, testOffering.course.courseNumber, testGrade);
        assertEquals(testStudent.roster.studentRoster.get(testOffering), testGrade);
    }
}
